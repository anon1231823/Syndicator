...
for class, classDetails in pairs(ClassData) do
  Syndicator.Search.Constants.ClassGear[class] = {}
  for spec, specDetails in pairs(classDetails) do
    Syndicator.Search.Constants.ClassGear[class][spec] = {}
    for _, typeDetails in ipairs(specDetails) do
      Syndicator.Search.Constants.ClassGear[class][typeDetails[1]] = Syndicator.Search.Constants.ClassGear[class][typeDetails[1]] or {}
      Syndicator.Search.Constants.ClassGear[class][typeDetails[1]][typeDetails[2]] = Syndicator.Search.Constants.ClassGear[class][typeDetails[1]][typeDetails[2]] or {}
      if typeDetails[3] then
        Syndicator.Search.Constants.ClassGear[class][typeDetails[1]][typeDetails[2]][typeDetails[3]] = true
      end
    end
  end
end
